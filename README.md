...
当前版本：**v1.36.9** · [修改记录](CHANGELOG.md)
...
打开图片时默认进入覆盖当前显示器工作区的无边框沉浸预览，桌面背景会变暗并使用 Windows 毛玻璃。小图按当前 DPI 下的 100% 逻辑尺寸显示；横图最多占工作区宽度的 90% 和高度的 82.5%，竖图只在宽度超过 90% 时缩小，超出高度的部分可上下拖动查看。
